...
export const DAY3: DayContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      bad: { en: "\"That's not my job. Go to the counter.\"", vi: "\"Đó không phải việc tôi. Ra quầy đi.\"" },
      good: { en: "\"I'll take you to the counter — they can help with that.\"", vi: "\"Tôi đưa bạn ra quầy — họ sẽ giúp việc đó.\"" },
    },
    {
      id: "d3s3",
      type: "text",
...
export const DAY6: DayContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      options: [
        { en: "The prices are over there", vi: "Bảng giá ở đằng kia" },
        { en: "I got you — I'll walk you through everything", vi: "Tôi hướng dẫn bạn từng bước" },
        { en: "ignore nervous behavior", vi: "lờ hành vi lo lắng" },
      ],
      correctIndex: 0,
      wrongExplanationEn: "That phrase is fine. The mistake is 'The prices are over there' — we never point directions. Tap that phrase.",
      wrongExplanationVi: "Cụm đó ổn. Lỗi là 'Bảng giá ở đằng kia' — chúng ta không chỉ hướng. Chạm vào cụm đó.",
      rightExplanationEn: "Correct. You identified the phrase we never say. Never point 'over there' — walk them and explain simply.",
      rightExplanationVi: "Đúng. Bạn đã chỉ ra cụm không nên nói. Đừng chỉ 'ở đằng kia' — dẫn họ và giải thích đơn giản.",
