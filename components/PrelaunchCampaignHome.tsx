...
function HomeContent() {
  ...
  const basePath = useMemo(() => prelaunchBasePath(pathname, locale), [pathname, locale]);
...
export default function PrelaunchCampaignHome() {
  return (
