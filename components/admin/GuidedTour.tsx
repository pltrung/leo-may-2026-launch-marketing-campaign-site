...
export interface TourStepNavigate {
  ...
  analyticsTab?: "overview" | "revenue_members" | "engagement" | "ops_team" | "marketing" | "acquisition" | "finance";
...
export const TOUR_STEPS_ADMIN: TourStep[] = [
  ...
  // 4. ANALYTICS
  { id: "area-analytics", target: "[data-tour=area-analytics]", titleEn: "Analytics & reporting", titleVi: "Phân tích & báo cáo", contentEn: "Seven tabs: Executive → Revenue & members → Engagement → Ops & team → CRM & Email (lifecycle) → Paid Ads (acquisition funnel) → Finance.", contentVi: "Bảy tab: Điều hành → Doanh thu & TV → Tương tác → VH & đội → CRM & Email (vòng đời) → Quảng cáo trả phí (phễu acquisition) → Tài chính.", navigate: { area: "analytics" } },
  ...
  { id: "analytics-marketing", target: "[data-tour=analytics-tab-marketing]", titleEn: "CRM & Email", titleVi: "CRM & Email", contentEn: "Owned channels: send email campaigns to lifecycle segments, view recent sends. Not for paid ad reporting.", contentVi: "Kênh sở hữu: gửi email theo phân khúc vòng đời, xem lần gửi gần đây. Không dùng cho báo cáo quảng cáo trả phí.", navigate: { area: "analytics", analyticsTab: "marketing" } },
  { id: "analytics-acquisition", target: "[data-tour=analytics-tab-acquisition]", titleEn: "Paid Ads", titleVi: "Quảng cáo trả phí", contentEn: "Paid ad performance: spend, funnel (lead→signup→purchase→first check-in), package conversion, landing pages.", contentVi: "Hiệu suất quảng cáo trả phí: chi phí, phễu, chuyển đổi gói, trang đích.", navigate: { area: "analytics", analyticsTab: "acquisition" } },
