...
export const TOUR_STEPS_STAFF: TourStep[] = [
  { id: "area-staff", target: "[data-tour=area-staff]", titleEn: "Staff — your home tab", titleVi: "Nhân sự — tab chính", contentEn: "Your nav usually starts with Staff, then Front Desk if you can work the counter. Here: tasks, routes, coaching. Check in for your shift first — then a bar above shows today’s sales and commission from check-ins and POS.", contentVi: "Menu thường bắt đầu bằng Nhân sự, rồi Quầy lễ tân nếu bạn làm quầy. Tại đây: nhiệm vụ, tường, coaching. Check-in ca trước — thanh phía trên sẽ hiện doanh số và hoa hồng hôm nay từ check-in và POS.", navigate: { area: "staff" } },
  { id: "staff-status-banner", target: "[data-tour=staff-status-banner]", titleEn: "Today at a glance", titleVi: "Tóm tắt hôm nay", contentEn: "Gym readiness, task progress for the current phase, coaching sessions today, and route-reset alerts — scan this strip when you start your shift.", contentVi: "Gym sẵn sàng, tiến độ nhiệm vụ theo giai đoạn, coaching hôm nay và cảnh báo reset tường — xem nhanh khi vào ca.", navigate: { area: "staff" } },
...
export const TOUR_STEPS_ADMIN: TourStep[] = [
  ...
  { id: "analytics-finance", target: "[data-tour=analytics-tab-finance]", titleEn: "Finance", titleVi: "Tài chính", contentEn: "This month P&amp;L, payroll, expenses, and the Forecast tab for runway and scenarios.", contentVi: "P&amp;L tháng này, lương, chi phí và tab Dự báo cho đường băng và kịch bản.", navigate: { area: "analytics", analyticsTab: "finance" } },
];
...
export const TOUR_STEPS_ONBOARDING: TourStep[] = [
  ...
  { id: "onb-pass", target: "[data-tour=dashboard-membership]", titleEn: "Step 2: Get a pass or membership", titleVi: "Bước 2: Mua pass hoặc gói", contentEn: "Buy a Day Pass, visit pack, or membership so you can check in. Open the Membership tab (Thẻ TV / Membership) below to pay or pick a plan.", contentVi: "Mua Day Pass, gói lượt hoặc gói thành viên để check-in. Mở tab Thẻ thành viên bên dưới để thanh toán hoặc chọn gói.", navigate: { dashboardTab: "membership" } },
...
export const TOUR_STEPS_DASHBOARD: TourStep[] = [
  ...
  { id: "dash-qr", target: "[data-tour=dashboard-qr]", titleEn: "Check-in QR", titleVi: "QR check-in", contentEn: "After waiver, active pass, and profile photo, your QR appears here. Show it at the front desk; tap to enlarge.", contentVi: "Sau waiver, pass còn hạn và ảnh hồ sơ, mã QR hiện tại đây. Đưa cho quầy lễ tân; chạm để phóng to." },
  ...
  { id: "dash-redeem", target: "[data-tour=dashboard-redeem]", titleEn: "Redeem codes", titleVi: "Đổi mã", contentEn: "Enter campaign promo codes or guest passes from email or friends. Milestone guest codes from your Activity tab are redeemed here too.", contentVi: "Nhập mã khuyến mãi hoặc vé khách từ email/bạn bè. Mã vé khách mốc trong tab Hoạt động cũng đổi tại đây.", navigate: { dashboardTab: "redeem" } },
