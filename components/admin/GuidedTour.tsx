...
/** Member dashboard first-time: waiver → profile photo → visits (buy pass OR redeem LMG- friend code). */
export const TOUR_STEPS_ONBOARDING: TourStep[] = [
  ...
  { id: "onb-profile", target: "[data-tour=dashboard-profile]", titleEn: "Step 2: Add your profile photo", titleVi: "Bước 2: Thêm ảnh hồ sơ", contentEn: "Add a profile photo so the front desk can identify you at check-in. Tap your name at the top to open your profile and add a photo.", contentVi: "Thêm ảnh hồ sơ để quầy lễ tân nhận diện khi check-in. Chạm vào tên của bạn ở trên để mở hồ sơ và thêm ảnh." },
...
export const TOUR_STEPS_DASHBOARD: TourStep[] = [
  ...
  { id: "dash-qr", target: "[data-tour=dashboard-qr]", titleEn: "Check-in QR", titleVi: "QR check-in", contentEn: "After waiver, profile photo, and at least one visit (from a pass or a friend’s LMG- code), your QR appears here. Show it at the front desk; tap to enlarge.", contentVi: "Sau waiver, ảnh hồ sơ và ít nhất 1 lượt (từ pass hoặc mã LMG- của bạn), mã QR hiện tại đây. Đưa cho quầy lễ tân; chạm để phóng to." },
