...
export const TOUR_STEPS_ADMIN: TourStep[] = [
  ...
  { id: "analytics-overview", target: "[data-tour=analytics-tab-overview]", titleEn: "Executive summary", titleVi: "Tóm tắt điều hành", contentEn: "One screen for finance (MTD + forecast), revenue, members, retention, funnel, operations, staff, recent emails, and training—aligned with your filter period.", contentVi: "Một màn hình cho tài chính (tháng + dự báo), doanh thu, thành viên, giữ chân, phễu, vận hành, nhân sự, email gần đây và đào tạo—theo kỳ lọc bạn chọn.", navigate: { area: "analytics", analyticsTab: "overview" } },
...
export const TOUR_STEPS_DASHBOARD: TourStep[] = [
  ...
  { id: "dash-tabs", target: "[data-tour=dashboard-tabs]", titleEn: "Dashboard tabs", titleVi: "Các tab", contentEn: "Switch between Membership, Activity, Redeem (campaign or guest codes), Events, and Leaderboard.", contentVi: "Chuyển giữa Thẻ thành viên, Hoạt động, Đổi mã (email hoặc vé khách), Sự kiện và Bảng xếp hạng." },
