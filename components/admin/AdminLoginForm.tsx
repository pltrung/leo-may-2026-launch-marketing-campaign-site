    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-900 p-4">
      ...
      <div className="w-full max-w-sm rounded-2xl bg-slate-800 border border-slate-700 shadow-xl p-6">
        <div className="mb-4 flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-slate-100 tracking-wide">Leo Mây Admin</span>
        </div>
        <h1 className="text-xl font-bold text-white mb-1" style={{ fontFamily: "var(--font-bold), MiSans-Bold, sans-serif" }}>
          {m.loginTitle}
        </h1>
        <p className="text-sm text-slate-400 mb-6">{m.loginSubtitle}</p>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-3 py-2 rounded-lg border border-slate-600 bg-slate-900 text-white text-sm placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500"
            />
          </div>
          <div>
