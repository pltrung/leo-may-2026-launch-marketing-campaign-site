...
export default function CloudCard({ cloud, onJoin }: CloudCardProps) {
  ...
  return (
    <div
      ref={cardRef}
      className={`w-full min-w-[140px] max-w-[200px] lg:max-w-none aspect-[3/4] lg:max-h-[65vh] mx-auto cursor-pointer transition-all duration-300 ease-out ${isHovered && !isFlipped ? "-translate-y-1" : ""} ${isFlipped ? "lg:!max-w-[380px] lg:!min-h-[420px] lg:!max-h-[85vh] lg:!aspect-auto lg:z-20" : ""}`}
    ...
    >
      ...
      >
        ...
        {/* Back: when expanded (desktop) allow content to fit without scroll */}
        <div
        ...
        >
          <p className="font-body text-center text-xs sm:text-sm leading-[1.5] flex-1 min-h-0 px-2 py-1 flex items-center justify-center text-[#1a1a1a]" style={{ opacity: 0.9 }}>
            {story}
          </p>
