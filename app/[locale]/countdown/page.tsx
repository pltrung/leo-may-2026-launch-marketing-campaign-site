...
/** Scarf and ribbon overlay for evo 1–5 (extracted from final form, scaled to 1024); applies nose/scarf colors per cloud type. */
 ...
 * Scarf, ribbon, cloud-outline are only applied when the SVG has those element IDs (evo 1–5 SVGs may not have them).
...
function MascotSvgObject({
  ...
  const applyColors = useCallback(
    (doc: Document | null) => {
      ...
      // Evo 0–1: left eye stays blue (open); only right eye gets species color
      if (!leftEyeFixedBlue) {
